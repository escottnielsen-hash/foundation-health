...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
        ...
        {mobileMenuOpen && (
          <div id="nav-mobile-menu" className="md:hidden bg-white border-t">
            <div className="px-4 py-4 space-y-4">
              ...
              <a href="#team" className="block text-gray-700 hover:text-primary-600">Team</a>
      ...
      {/* Hero Section */}
      <section id="hero-section" className="pt-24 pb-16 bg-gradient-to-br from-primary-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div id="hero-content">
              ...
              <p id="hero-description" className="text-xl text-gray-600 mb-8">
            ...
            <div id="hero-image-container" className="relative h-96 bg-gradient-to-br from-primary-200 to-primary-100 rounded-2xl flex items-center justify-center">
      ...
      <section id="services-section" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div id="services-grid" className="grid md:grid-cols-3 gap-8">
            {/* Service 1 */}
            <div id="service-preventive-card" className="bg-white p-8 rounded-xl border-2 border-gray-100 hover:border-primary-200 hover:shadow-lg transition-all duration-300">
              <div id="service-preventive-icon" className="w-16 h-16 bg-primary-100 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 id="service-preventive-title" className="text-2xl font-bold text-gray-900 mb-4">Preventive Care</h3>
              <p id="service-preventive-description" className="text-gray-600 mb-6">
                Regular check-ups, screenings, and health assessments to keep you healthy and detect issues early.
              </p>
              <button id="service-preventive-cta" className="text-primary-600 font-semibold hover:text-primary-700 flex items-center">
                Learn More
            ...
            {/* Service 2 */}
            <div id="service-wellness-card" className="bg-white p-8 rounded-xl border-2 border-gray-100 hover:border-primary-200 hover:shadow-lg transition-all duration-300">
              <div id="service-wellness-icon" className="w-16 h-16 bg-primary-100 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                </svg>
              </div>
              <h3 id="service-wellness-title" className="text-2xl font-bold text-gray-900 mb-4">Wellness Programs</h3>
              <p id="service-wellness-description" className="text-gray-600 mb-6">
                Personalized nutrition, fitness, and lifestyle programs designed to optimize your overall wellbeing.
              </p>
              <button id="service-wellness-cta" className="text-primary-600 font-semibold hover:text-primary-700 flex items-center">
                Learn More
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
            ...
            {/* Service 3 */}
            <div id="service-specialist-card" className="bg-white p-8 rounded-xl border-2 border-gray-100 hover:border-primary-200 hover:shadow-lg transition-all duration-300">
              <div id="service-specialist-icon" className="w-16 h-16 bg-primary-100 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 id="service-specialist-title" className="text-2xl font-bold text-gray-900 mb-4">Specialist Care</h3>
              <p id="service-specialist-description" className="text-gray-600 mb-6">
                Access to top specialists and coordinated care for complex health conditions and specialized treatment.
              </p>
              <button id="service-specialist-cta" className="text-primary-600 font-semibold hover:text-primary-700 flex items-center">
                Learn More
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
      ...
      {/* Stats Section */}
      <section id="stats-section" className="py-20 bg-primary-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section id="about-section" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div id="about-image-container" className="relative h-96 bg-gradient-to-br from-primary-100 to-primary-50 rounded-2xl"></div>
            <div id="about-content">
              ...
              <p id="about-mission" className="text-lg text-gray-600 mb-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div id="footer-content" className="grid md:grid-cols-4 gap-8">
            <div id="footer-brand">
              ...
              <p className="text-gray-400">Building healthier futures together.</p>
            </div>
