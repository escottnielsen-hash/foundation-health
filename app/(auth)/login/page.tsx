  ...
  return (
    <Card id="login-card" className="w-full">
      <CardHeader id="login-header" className="text-center">
        <div id="login-logo" className="mx-auto mb-4">
      ...
      <CardContent>
        <form id={formId('login')} onSubmit={handleLogin} className="space-y-4">
          {error && (
            <div id="login-error" className="p-3 rounded-lg bg-red-50 text-red-600 text-sm">
              {error}
            </div>
          )}
          ...
          <div id="login-remember" className="flex items-center">
            <input
              id="remember-me"
              type="checkbox"
        ...
        <div id="login-oauth-buttons" className="grid grid-cols-2 gap-3">
          <Button
            id={btnId('login', 'google')}
            variant="outline"
      ...
      <CardFooter id="login-footer" className="justify-center">
